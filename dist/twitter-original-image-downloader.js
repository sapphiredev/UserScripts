...
// @author       sapphire
// @downloadURL  https://raw.githubusercontent.com/sapphiredev/UserScripts/release/dist/twitter-original-image-downloader.js
// @version      1600389142779
...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/scripts/twitter-original-image-downloader.ts");
/******/ })
/************************************************************************/
/******/ ({
...
Object.defineProperty(exports, "__esModule", { value: true });
__exportStar(__webpack_require__(/*! ./sleep */ "./src/helpers/sleep.ts"), exports);
...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    function generateHandler(images) {
        ...
        return function () { return __awaiter(_this, void 0, void 0, function () {
            var _i, images_1, src, url, x;
            return __generator(this, function (_a) {
                for (_i = 0, images_1 = images; _i < images_1.length; _i++) {
                    src = images_1[_i].src;
                    url = src.replace(/name=\w+$/, 'name=orig');
                    x = open(url);
                }
                return [2 /*return*/];
            });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        e = document.querySelectorAll('article');
                        articles = Array.from(e);
                        return [2 /*return*/, articles.filter(function (x) {
                                var e = x.querySelector('article div[role="group"]');
                                return e !== null;
                            })];
                }
            });
    ...
    function getImages(article) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, waitForElement('img[alt="Image"]')];
                    case 1:
                        _a.sent();
                        e = article.querySelectorAll('img[alt="Image"]');
                        images = Array.from(e);
                        if (images.length === 4) {
                            t = images[1];
                            images[1] = images[2];
    ...
    var articles, _i, articles_1, article, images, button;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, getArticles()];
            case 1:
                articles = _a.sent();
